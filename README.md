...
> Calculate the [standard deviation][standard-deviation] of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values.
...
```javascript
dnanstdev = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-dnanstdev@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanstdev = require( 'path/to/vendor/umd/stats-base-ndarray-dnanstdev/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray-dnanstdev@umd/browser.js"></script>
```
...
Computes the [standard deviation][standard-deviation] of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-base-ndarray-dnanstdev.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-base-ndarray-dnanstdev

[test-image]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-base-ndarray-dnanstdev/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-base-ndarray-dnanstdev?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-ndarray-dnanstdev.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-ndarray-dnanstdev/main
...
[deno-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-ndarray-dnanstdev/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-ndarray-dnanstdev/main/LICENSE
