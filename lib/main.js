...
var strided = require( '@stdlib/stats-strided-dnanstdev' ).ndarray;


// MAIN //

/**
* Computes the standard deviation of a one-dimensional double-precision floating-point ndarray, ignoring `NaN` values.
*
...
* };
*
* var xbuf = new Float64Array( [ 2.0, 1.0, 2.0, -2.0, -2.0, 2.0, 3.0, 4.0, NaN ] );
